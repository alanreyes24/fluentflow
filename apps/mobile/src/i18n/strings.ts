...
export const en = {
  ...
  aiModelConfirm: 'Send only these missing words to {model}? Estimated maximum cost: {cost}.',
  aiAskModelConfirm: 'Send to Gemini',
...
const es: Strings = {
  ...
  aiModelConfirm: '¿Enviar solo estas palabras sin significado a {model}? Coste máximo estimado: {cost}.',
  aiAskModelConfirm: 'Enviar a Gemini',
...
const bs: Strings = {
  ...
  aiModelConfirm: 'Poslati samo ove riječi bez značenja na {model}? Procijenjeni najveći trošak: {cost}.',
  aiAskModelConfirm: 'Pošalji Geminiju',
