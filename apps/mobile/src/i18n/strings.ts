...
export const en = {
  ...
  tags: 'Tags',
  tagsHint: 'Optional labels, separated by commas.',
  searchCards: 'Search cards',
  searchCardsHint: 'Search words, meanings, and tags.',
  cardLibrary: 'Library',
  allCards: 'All cards',
  activeCards: 'Active',
  suspendedCards: 'Suspended',
  starredCards: 'Starred',
  ...
  pronunciationUnavailable: 'Pronunciation is unavailable on this device.',
  save: 'Save',
  cancel: 'Cancel',
  delete: 'Delete',
  edit: 'Edit',
  ...
  regenerateExamples: 'Regenerate examples',
  regenerateDefinition: 'Regenerate definition',
  generatingDefinition: 'Writing definition…',
...
const es: Strings = {
  ...
  tags: 'Etiquetas',
  tagsHint: 'Etiquetas opcionales, separadas por comas.',
  searchCards: 'Buscar tarjetas',
  searchCardsHint: 'Busca palabras, significados y etiquetas.',
  cardLibrary: 'Biblioteca',
  allCards: 'Todas',
  activeCards: 'Activas',
  suspendedCards: 'Suspendidas',
  starredCards: 'Favoritas',
  noMatchingCards: 'Ninguna tarjeta coincide con estos filtros.',
  selectedCards: '{count} seleccionadas',
  selectCard: 'Seleccionar {card}',
  clearSelection: 'Borrar selección',
  suspendSelected: 'Suspender seleccionadas',
  resumeSelected: 'Reanudar seleccionadas',
  starSelected: 'Marcar seleccionadas',
  unstarSelected: 'Quitar favorito',
  addTag: 'Añadir etiqueta',
  applyTag: 'Aplicar etiqueta',
  removeTag: 'Quitar etiqueta',
  bulkDelete: 'Eliminar seleccionadas',
  pronunciation: 'Pronunciar {word}',
  pronunciationUnavailable: 'La pronunciación no está disponible en este dispositivo.',
  save: 'Guardar',
  cancel: 'Cancelar',
  delete: 'Eliminar',
  edit: 'Editar',
  ...
  regenerateExamples: 'Regenerar ejemplos',
  regenerateDefinition: 'Regenerar definición',
  generatingDefinition: 'Escribiendo definición…',
...
const bs: Strings = {
  ...
  tags: 'Oznake',
  tagsHint: 'Neobavezne oznake, odvojene zarezima.',
  searchCards: 'Pretraži kartice',
  searchCardsHint: 'Pretraži riječi, značenja i oznake.',
  cardLibrary: 'Biblioteka',
  allCards: 'Sve',
  activeCards: 'Aktivne',
  suspendedCards: 'Suspendovane',
  starredCards: 'Označene zvjezdicom',
  noMatchingCards: 'Nijedna kartica ne odgovara ovim filterima.',
  selectedCards: '{count} odabrano',
  selectCard: 'Odaberi {card}',
  clearSelection: 'Očisti odabir',
  suspendSelected: 'Suspenduj odabrano',
  resumeSelected: 'Nastavi odabrano',
  starSelected: 'Označi odabrano zvjezdicom',
  unstarSelected: 'Ukloni zvjezdicu s odabranog',
  addTag: 'Dodaj oznaku',
  applyTag: 'Primijeni oznaku',
  removeTag: 'Ukloni oznaku',
  bulkDelete: 'Izbriši odabrano',
  pronunciation: 'Izgovori {word}',
  pronunciationUnavailable: 'Izgovor nije dostupan na ovom uređaju.',
  ...
  regenerateExamples: 'Ponovo generiši primjere',
  regenerateDefinition: 'Ponovo generiši značenje',
  generatingDefinition: 'Pišem značenje…',
  ...
  upcomingWorkload: 'Predstojeće obaveze',
  dueTomorrow: 'Za sutra',
  dueThisWeek: 'Ove sedmice',
  recentActivity: 'Nedavna aktivnost',
  reviewedTodayLabel: 'Ponovljeno danas',
  lastSevenDays: 'Posljednjih 7 dana',
  lastSession: 'Posljednja sesija: {date}',
  noActivityYet: 'Još nema ponavljanja',
