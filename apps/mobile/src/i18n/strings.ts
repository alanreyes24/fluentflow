...
export const en = {
  ...
  pasteExpand: 'Show more',
  pasteCollapse: 'Show less',
  ...
  aiUnresolvedWillSkip: '{count} could not be assigned a meaning and will be skipped.',
  aiNoMoreAttempts: 'Gemini already tried these words; unresolved ones will be skipped.',
  aiUnavailableNoManual: 'Gemini is not connected, so unresolved words cannot be added.',
  aiSourceDictionary:
...
const es: Strings = {
  ...
  pasteShort: 'Pegar',
  pasteLabel: 'Tu lista',
  pasteExpand: 'Mostrar más',
  pasteCollapse: 'Mostrar menos',
  ...
  aiUnresolvedWillSkip: '{count} no pudo recibir un significado y se omitirá.',
  aiNoMoreAttempts: 'Gemini ya probó estas palabras; las que sigan sin resolver se omitirán.',
  aiUnavailableNoManual: 'Gemini no está conectado; las palabras sin significado no se pueden añadir.',
  aiSourceDictionary:
...
const bs: Strings = {
  ...
  pasteExpand: 'Prikaži više',
  pasteCollapse: 'Prikaži manje',
  ...
  aiUnresolvedWillSkip: '{count} nije dobilo značenje i bit će preskočeno.',
  aiNoMoreAttempts: 'Gemini je već pokušao s ovim riječima; neriješene će biti preskočene.',
  aiUnavailableNoManual: 'Gemini nije povezan, pa se riječi bez značenja ne mogu dodati.',
  aiSourceDictionary:
